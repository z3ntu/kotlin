            ...
            arguments.script -> {
                ...
                if (script == null && defaultScriptExtension != null) {
                    script = ExplicitlyNamedFileScriptSource(
                        scriptFile, explicitName = scriptFile.nameWithoutExtension + defaultScriptExtension
                    ).takeIf {
                        scriptDefinitionProvider.isScript(it)
                    }
                }
...
open class ExplicitlyNamedFileScriptSource(
    file: File, preloadedText: String? = null, protected val explicitName: String? = null
) : FileScriptSource(file, preloadedText), Serializable {

    override val name: String? get() = explicitName ?: super.name
