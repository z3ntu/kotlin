...
extra["tasksWithWarnings"] = listOf(
    ...
    ":kotlin-noarg-compiler-plugin:compileTestKotlin",
    ":kotlinx-serialization-compiler-plugin:compileTestKotlin",
    ":kotlin-sam-with-receiver-compiler-plugin:compileTestKotlin",
    ":compiler:tests-common:compileTestKotlin",
    ":compiler:tests-spec:compileTestKotlin",
    ":compiler:compileTestKotlin"
)
